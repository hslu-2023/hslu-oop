...
public class TemperatureProgression implements TemperatureProgressionInterface {
    ...
    public Measurement getMaxMeasurement() {
        if (measurementList.isEmpty()) {
            return new Measurement(Temperature.createFromCelsius(Float.NaN));
        }
        return new Measurement(Collections.max(this.measurementList).getTemperature());
    }
    ...
    public Measurement getMinMeasurement() {
        ...
        return new Measurement(Collections.min(this.measurementList).getTemperature());
    }
