...
public class Point implements Comparable<Point> {
    ...
    public final boolean equals(final Object object) {
        ...
        return (object instanceof Point p)
                && (p.xCoordinate == this.xCoordinate)
                && (p.yCoordinate == this.yCoordinate);
    }
    ...
    public int compareTo(final Point other) {
        ...
        int thisDistanceSquared = this.xCoordinate * this.xCoordinate + this.yCoordinate * this.yCoordinate;
        int otherDistanceSquared = other.xCoordinate * other.xCoordinate + other.yCoordinate * other.yCoordinate;

        return Integer.compare(thisDistanceSquared, otherDistanceSquared);
    }
}
